...
|---------|------------|------------------|---------------|----------------------|---------------------|
| old_controller_ab | 0.6019 | 0.7129852190396042 | 0.8014467736944193 | 0.6811 | 0.7701 |
| geometry_controller_v0 | 0.5920 | 0.6920300716702865 | 0.7809371089577877 | 0.7206 | 0.8091 |

### 2.2 性能排名

**按ALC排名**:

1. old_controller_ab: 0.6019
2. geometry_controller_v0: 0.5920

**按最终报告mIoU(test)排名**:

1. geometry_controller_v0: 0.7206
2. old_controller_ab: 0.6811
