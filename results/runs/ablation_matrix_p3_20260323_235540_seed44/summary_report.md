...
|---------|------------|------------------|---------------|----------------------|---------------------|
| old_controller_ab | 0.5884 | 0.696332736183667 | 0.785339870770204 | 0.7011 | 0.7904 |
| geometry_controller_v0 | 0.6031 | 0.706301298759022 | 0.7949809515698197 | 0.6972 | 0.7865 |

### 2.2 性能排名

**按ALC排名**:

1. geometry_controller_v0: 0.6031
2. old_controller_ab: 0.5884

**按最终报告mIoU(test)排名**:

1. old_controller_ab: 0.7011
2. geometry_controller_v0: 0.6972
