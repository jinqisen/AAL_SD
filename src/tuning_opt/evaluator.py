...
class ExperimentEvaluator:
    ...
    def collect_results(self, *, run_id: str, exp_names: Iterable[str]) -> Dict[str, EvalResult]:
        ...
        for exp_name in exp_names:
            ...
            out[exp_name] = EvalResult(exp_name=str(exp_name), miou=miou, md_path=str(md_path))
        return out
